...
var Emitter = /** @class */ (function (_super) {
    ...
    function Emitter(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.emission, emission = _c === void 0 ? 100 : _c, _d = _b.anchor, anchor = _d === void 0 ? new Vector3(0, 0, 0) : _d, _e = _b.particlesPositionRandom, particlesPositionRandom = _e === void 0 ? null : _e, _f = _b.particlesOpacityRandom, particlesOpacityRandom = _f === void 0 ? 0 : _f, _g = _b.particlesOpacityKey, particlesOpacityKey = _g === void 0 ? [] : _g, _h = _b.particlesOpacityValue, particlesOpacityValue = _h === void 0 ? [] : _h, _j = _b.particlesColorRandom, particlesColorRandom = _j === void 0 ? [0, 0, 0] : _j, _k = _b.particlesColorKey, particlesColorKey = _k === void 0 ? [] : _k, _l = _b.particlesColorValue, particlesColorValue = _l === void 0 ? [] : _l, _m = _b.particlesRotationRandom, particlesRotationRandom = _m === void 0 ? new Vector3(0, 0, 0) : _m, _o = _b.particlesRotationKey, particlesRotationKey = _o === void 0 ? [] : _o, _p = _b.particlesRotationValue, particlesRotationValue = _p === void 0 ? [] : _p, _q = _b.particlesScaleRandom, particlesScaleRandom = _q === void 0 ? new Vector3(0, 0, 0) : _q, _r = _b.particlesScaleKey, particlesScaleKey = _r === void 0 ? [] : _r, _s = _b.particlesScaleValue, particlesScaleValue = _s === void 0 ? [] : _s;
        var _this = _super.call(this) || this;
...
var DirectionEmitter = /** @class */ (function (_super) {
    ...
    function DirectionEmitter(_a) {
        if (_a === void 0) { _a = {}; }
        var _b = _a.direction, direction = _b === void 0 ? new Vector3(0, 0, -1) : _b, _c = _a.spread, spread = _c === void 0 ? 0 : _c, _d = _a.radius, radius = _d === void 0 ? new Vector3(0, 0, 0) : _d, _e = _a.emitType, emitType = _e === void 0 ? DirectionEmitter.EMIT_TYPE_SHPERE : _e, options = __rest(_a, ["direction", "spread", "radius", "emitType"]);
    ...
    DirectionEmitter.prototype.generate = function () {
        var baseVector3 = new Vector3(0, 0, 1);
        ...
        for (var i = 0; i < generatedParticles.length; i++) {
            ...
            // 初始化粒子方向
            generatedParticles[i].direction = new Vector3(this.direction.x + Math$1.randFloatSpread(this.spread), this.direction.y + Math$1.randFloatSpread(this.spread), this.direction.z + Math$1.randFloatSpread(this.spread)).normalize();
        }
        return generatedParticles;
    };
