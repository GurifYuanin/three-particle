...
var Sphere = /** @class */ (function (_super) {
    ...
    function Sphere(_a) {
        ...
        // 设置 glow
        if (_this.glow) {
            _this.add(new Mesh(new SphereBufferGeometry(radius * _this.glow.size, widthSegments, heightSegments), _this.glow.getShaderMaterial()));
        }
        _this.type = 'Sphere';
        return _this;
    }
...
var Glow = /** @class */ (function () {
    function Glow(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.opacity, opacity = _c === void 0 ? 0.5 : _c, _d = _b.intensity, intensity = _d === void 0 ? 1 : _d, _e = _b.feature, feature = _e === void 0 ? 5 : _e, _f = _b.size, size = _f === void 0 ? 1.1 : _f, _g = _b.color, color = _g === void 0 ? new Color(0x00ffff) : _g;
        ...
        this.bias = Math$1.mapLinear(intensity, 0, 5, 1.0, 0.0);
...
export { Sphere, Line$1 as Line, Points$1 as Points, Text, Sprite$1 as Sprite, Emitter, ExplosionEmitter, DirectionEmitter, BoxEmitter, Gravity, Wind, Turbulent, Glow };
